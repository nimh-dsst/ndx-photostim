...
slm = NWBGroupSpec(name='slm', neurodata_type_def='SpatialLightModulator', neurodata_type_inc='Device',
                   doc='slm',
                   attributes=[
                       NWBAttributeSpec('size', 'size of slm', 'numeric', shape=((2,), (3,)), required=False)], quantity='?')
...
image_mask_roi = NWBDatasetSpec(doc='ROI masks for each ROI. Each image mask is the size of the original imaging plane (or'
...
hp = NWBGroupSpec(neurodata_type_def='HolographicPattern', neurodata_type_inc='NWBContainer',
                  ...
                  attributes=[
                      NWBAttributeSpec('dimension', 'dimension of hp', 'numeric', shape=((2,), (3,)), required=False)],
...
sp = NWBGroupSpec(neurodata_type_def='StimulusPresentation', neurodata_type_inc='TimeIntervals',
                  ...
                  quantity='?',
                  links=[NWBLinkSpec(name='photostimulation_device', doc='photostimulation device', target_type='PhotostimulationDevice')]
                  )
