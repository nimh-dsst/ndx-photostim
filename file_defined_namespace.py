...
size = NWBAttributeSpec(name='size',
                        doc=("Resolution of SpatialLightModulator (in pixels), formatted as [width, height] or [width, height, depth]."),
                        dtype='numeric',
                        shape=((2,), (3,)),
...
attribs = [NWBAttributeSpec(name='sweep_pattern',
                            doc=("Sweeping method, if spatially modulated during stimulation (none, or other). Requires 'stim_method' is specified. (ex. logspiral)"),
                            dtype='text',
                            required=True),
