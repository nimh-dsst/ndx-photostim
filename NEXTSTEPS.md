...
# Next Steps for ndx-photostim Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-photostim directory.
...
`spec/ndx-photostim.namespace.yaml` and
`spec/ndx-photostim.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-photostim
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/carlwharris/ndx-photostim/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-photostim/0.1.0
...
`staged-extensions/ndx-photostim`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-photostim
    ```

13. Edit `staged-extensions/ndx-photostim/ndx-meta.yaml`
...
14. Edit `staged-extensions/ndx-photostim/README.md`
to add information about your extension. You may copy it from
`ndx-photostim/README.md`.

  ```bash
  cp ndx-photostim/README.md staged-extensions/ndx-photostim/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-photostim
git commit -m "Add new catalog entry for ndx-photostim" .
git push
```
...
ndx-photostim-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-photostim GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-photostim-record repository on GitHub.
